...
- **[PR-01 — Release-readiness baseline](PR01_RELEASE_READINESS_BASELINE.md)** — eerste serieuze V2-release: doel, scope, testcategorieën, field-testcriteria, blockers/known issues, artifact-discipline; vervolg **PR-02…PR-04**.
- **[PR-02 — Testmatrix + eerste run](PR02_TEST_MATRIX.md)** — TM-01…TM-09 (build t/m NTFY/MQTT), uitvoerbare stappen, invul-template; basis voor **PR-03**.
