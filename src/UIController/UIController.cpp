...
void UIController::updateTrendLabel()
{
    ...
    if (hasRet2h && hasRet30m)
    {
        ...
        uint32_t trendColor32 = lv_color_to_32(trendColor, LV_OPA_COVER);
    ...
    else
    {
        ...
        if (!hasRet30m) {
            ...
            if (hasRet30mWarm) {
                ...
                uint32_t trendColor32 = lv_color_to_32(lv_palette_main(LV_PALETTE_GREY), LV_OPA_COVER);
                if (lastTrendColor != trendColor32) {
                    lv_obj_set_style_text_color(::trendLabel, lv_palette_main(LV_PALETTE_GREY), 0);
                    lastTrendColor = trendColor32;
                }
...
void UIController::updateVolatilityLabel()
{
    ...
    uint32_t volColor32 = lv_color_to_32(volColor, LV_OPA_COVER);
...
void UIController::updateVolumeConfirmLabel()
{
    ...
    uint32_t volumeColor32 = lv_color_to_32(volumeColor, LV_OPA_COVER);
...
void UIController::updateWarmStartStatusLabel()
{
    ...
    uint32_t statusColor32 = lv_color_to_32(statusColor, LV_OPA_COVER);
